...
$sentencia = $base_de_datos->query("SELECT * FROM Personal WHERE Baja = 1;");
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <a id="borrar" class="btn btn-info"
                                    ...
                                    <a id="borrar" class="btn btn-success"
                                    href="<?php echo "lib/Personal/Baja.php?bp=0&id=" . $usuario->ID_Personal?>"><i class="far fa-thumbs-up"></i></i></a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
