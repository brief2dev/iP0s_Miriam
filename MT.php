...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="page-title mb-0 font-size-18">Mutualista Abriertos</h4>
        ...
        <div class="card">
            <div class="card-body">
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        <?php 
                        $sqltable = "SELECT * FROM M_Mutualista WHERE Finalizado = 0 ";
                        ...
                        <tr>
                            ...
                            <td>'.$lectura['Nombre'].' '.$lectura['Apellidos'].'</td>
                            ...
                            <td>
                                ...
                                <a class="btn btn-warning" href="NMT.php?id='.$lectura['ID_Mutualista'].'"><i class="fa fa-edit"></i></a>
                                <a class="btn btn-danger" href="lib/Mutualista/close.php?id='.$lectura['ID_Mutualista'].'"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        ';
                        }
